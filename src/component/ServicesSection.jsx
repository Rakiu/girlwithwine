  ...
  return (
    <section className="w-full bg-[#E9F7FE] px-4 py-12 sm:py-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* ✅ SERVICE CARDS */}
       {/* ✅ SERVICE CARDS (FLEX CENTERED) */}
<div className="flex flex-wrap justify-center gap-6 sm:gap-10 mt-12 sm:mt-14">
  ...
  {services.map((service, index) => (
    ...
    >
      ...
      {/* ✅ DESCRIPTION (flex-grow makes equal height) */}
      <p className="p-4 pt-8 sm:pt-10 text-gray-700 text-sm sm:text-base leading-relaxed flex-grow">
        {service.description}
      </p>

      {/* ✅ CITY LIST */}
      <ul className="border-t mt-auto">
